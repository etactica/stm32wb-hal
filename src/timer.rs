...
use crate::stm32::{TIM16, TIM17, TIM2};
use cast::{u16, u32};
use void::Void;
...
macro_rules! hal {
    ($($TIM:ident: ($tim:ident, $frname:ident, $timXen:ident, $timXrst:ident, $apben:ident, $apbrst:ident, $width:ident),)+) => {
        $(
            ...
            impl Timer<$TIM> {
                    ...
                    T: Into<Hertz>,
                {
                    ...
                    rcc.rb.$apbrst.modify(|_, w| w.$timXrst().set_bit());
                    rcc.rb.$apbrst.modify(|_, w| w.$timXrst().clear_bit());
...
hal! {
    // SVD is broken: https://github.com/stm32-rs/stm32-rs/issues/626
    // TIM2:  (tim2, free_running_tim2, tim2en, tim2rst, apb1enr1, apb1rstr1, u32),
    TIM16: (tim16, free_running_tim16, tim16en, tim16rst, apb2enr, apb2rstr, u16),
    TIM17: (tim17, free_running_tim17, tim17en, tim17rst, apb2enr, apb2rstr, u16),
}
